          ...
          itineraries.map((itinerary, index) => (
            ...
            >
              ...
              <div className="mt-2 cursor-pointer">
                <button className='mt-2 bg-transparent border border-black text-black hover:text-white py-2 px-4 rounded hover:bg-gray-800 inline-block transition-colors duration-200 mr-3'
              ...
              {userModal && (
                ...
                >
                  <motion.div
                    ...
                    className="rounded-lg p-0 w-full max-w-5xl relative mx-2 md:mx-auto"
                  >
                    <AddUsersForm setUserModal={setUserModal} resetModal={resetModal} setEditingId={setEditingId} editingId={editingId} itineraryId={itinerary.id}/>
