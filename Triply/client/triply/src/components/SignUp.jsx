...
function Signup() {
  ...
  return (
    <section className="flex min-h-screen">
      {/* Left side: Branding */}
      <div className="hidden md:flex w-1/2 items-center justify-center bg-gradient-to-br from-blue-500 to-blue-700" data-aos="fade-right">
        <h1 className="text-white text-6xl font-extrabold select-none">Triply</h1>
      </div>

      {/* Right side: Sign-Up Form */}
      <div className="w-full md:w-1/2 flex flex-col items-center justify-center bg-white px-4 relative" data-aos="fade-up">
        {/* Optional Banner */}
        {showBanner && (
          <div
            className={`absolute -top-20 left-1/2 -translate-x-1/2 z-50 flex items-center gap-3 bg-green-200 text-green-900 px-8 py-4 rounded-xl shadow-lg text-lg font-semibold mt-6
              ${fadeState === 'down' ? 'pointer-events-none' : ''}`}
            data-aos={fadeState === 'up' ? 'fade-up' : fadeState === 'down' ? 'fade-down' : undefined}
