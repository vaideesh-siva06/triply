...
function Login() {
    ...
    <section data-aos="fade-up" data-aos-duration="1000" className="flex flex-col items-center justify-center min-h-[70vh] bg-white px-4">
        <div className="w-full max-w-md bg-white rounded-xl shadow-md p-8" style={{ boxShadow: '0 -4px 12px 0 rgba(0,0,0,0.08), 0 2px 4px 0 rgba(0,0,0,0.04)' }}>
            ...
            <form className="flex flex-col gap-4" onSubmit={handleSubmit} noValidate id="login">
                <div>
                ...
                <button type="submit" className="mt-4 bg-transparent text-black border-2 cursor-pointer hover:bg-black hover:text-white font-semibold py-2 rounded-lg transition duration-200">Login</button>
            </form>
            <p className="mt-4 text-center text-gray-600 text-sm">Don't have an account? <Link to={"/signup"} className="text-blue-600 hover:underline">Sign up</Link></p>
        </div>
    </section>
  );
}
